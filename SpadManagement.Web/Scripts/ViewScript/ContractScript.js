...
function fillGrid(Array, pageNumber, pageSize) {
    ...
    for (var i = 1; i <= Array.length; i++) {
        ...
        if (table != null) {
            ...
            cell9.innerHTML = generateInRowToolbar('Contract', Array[i - 1].Id, ' قرارداد ' + Array[i - 1].Title);
...
function submit() {
   ...
   var PersonValue = e.options[e.selectedIndex].value;
    ...
    var Contract = { CustomerId: customerValue,CustomerName:customerTitle,
        contractPlans: contractPlans, CustomerId: customerValue, PaymentTotalPrice: $('#PaymentTotalPrice').val(),
